  ...
  return (
    <div className='about-wrapper' style={localStorage.getItem('visited') === null ? { display: 'block'} : {display: 'none'}}>
      ...
      <header>
        ...
        />
        <h1>rei-search</h1>
        <h2>Start investing <br /> the right way</h2>
      </header>
      <div>
        ...
        <p>
          ...
          able to view properties for sale and catalogue them for later viewing.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          The app produces statistical data primarily on two geographic levels:
        </p>
        ...
        <ul>
          <li>
            ...
            MSAs are geographic regions centered around areas of high population
            density (i.e., big cities) with integrated economies. The
            Philadelphia-Camden-Wilmington, PA-NJ-DE-MD MSA will provide
          ...
          <li>
            ...
            correlating closely to city town boundaries. The more granular focus
            will provide investors with a better idea of how a municipality
            compares to the MSA as a whole.
          </li>
        </ul>
      ...
      <div>
        ...
        <ol>
          ...
          <li>
            Create an account to save select properties or proceed as a visitor
            and create an account at another time
          </li>
          <li>
