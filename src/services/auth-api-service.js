...
const AuthApiService = {
  postUser(user) {
    return fetch(`${config.REISEARCH_API_ENDPOINT}/users`, {
      method: "POST",
      headers: {
  ...
  postLogin({ user_name, password }) {
    return fetch(`${config.REISEARCH_API_ENDPOINT}/auth/login`, {
      method: "POST",
      headers: {
        "content-type": "application/json",
      },
  ...
  postRefreshToken() {
    return fetch(`${config.REISEARCH_API_ENDPOINT}/auth/refresh`, {
      method: "POST",
      headers: {
